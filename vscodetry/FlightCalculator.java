 ...
 */
 ...
 public class FlightCalculator {
	 public static void main(String[] args) {
		 ...
		 //Varibales for a the flight counter loop = 10 flights long
		 int flightCounter = 0;
		 do{
			 ...
			 System.out.println("----------------------------------------------------------------------------------");
			 System.out.println("Ingreso del vuelo " + (flightCounter+1)); 
			 do{
				 ...
				 if (pickedBag == 3) {
					 ...
					 if(seatChoice.equalsIgnoreCase("si")){
						 ...
						 if(specialSeat.equalsIgnoreCase("si")){
							 totalPrice = sMinPrice + SPECIAL_SEAT;
					 ...
					 "Escriba \"Si\" o \"No\". ");
						 ...
						 if(specialSeat.equalsIgnoreCase("si")){
							 totalPrice = xsMinPrice + SPECIAL_SEAT;
			 ...
			 save10flights[flightCounter] = totalFlightPrice;
			 ...
			 //saving the max price as every number is saved inside the array
			 if(flightCounter == 0) {
				 maxFlight = save10flights[flightCounter];
			 } else {
				 if(save10flights[flightCounter] >= save10flights[flightCounter-1]){
					 maxFlight = save10flights[flightCounter];
				 } else {
					 maxFlight = save10flights[flightCounter-1];
				 }
			 }
 
			 flightCounter++;
 
		 }while(flightCounter != 10);
 
		 System.out.println("El precio mas alto calculado de los ultimos vuelos es de $" + maxFlight);
		 System.out.println("----------------------------------------------------------------------------------");
		 
		 //To check the total price of one of the ten saved flights
		 System.out.print("Ingrese el numero de vuelo que desea ver su precio(1-10): ");
